...
const widgetTitles = {
  widget2: "Bekleyen Fiyat Teklifleri",
  widget3: "Açık Siparişler",
  widget4: "Toplam Sipariş Tutarı",
  widget5: "Satınalma Genel Özet",
  widget8: "Malzeme Kullanımları",
  widget9: "Teslim Alınmamış Siparişler",
  widget10: "En Çok Talep Edilen Malzeme Grupları",
  widget11: "Aylık Satınalma Trendi",
  widget16: "Malzeme Talepleri Durum Dağılımı",
  widget18: "Bekleyen Onaylarım",
  widget19: "Bekleyen Malzeme Talepleri",
};
...
function MainDashboard() {
  ...
  const selectedDashboard = watch("selectedSatinalmaDashboard");
  ...
  const content = (
    ...
    >
      ...
      <Checkbox name="widget10" onChange={handleCheckboxChange} checked={checkedWidgets.widget10}>
        En Çok Talep Edilen Malzeme Grupları
      </Checkbox>{" "}
      ...
      <Checkbox name="widget16" onChange={handleCheckboxChange} checked={checkedWidgets.widget16}>
        Malzeme Talepleri Durum Dağılımı
      </Checkbox>
