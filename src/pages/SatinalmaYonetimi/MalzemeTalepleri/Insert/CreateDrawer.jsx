...
export default function CreateModal({ selectedLokasyonId, onRefresh }) {
  ...
  const Body = {
    ...
    baslik: data.baslik || "",
    talepEdenPersonelId: Number(data.talepEdenPersonelId) || 0,
    talepEden: data.talepEden || "",
    talepEdilen: data.talepEdilen || "",
    talepEdilenKisiId: Number(data.talepEdilenKisiId) || 0,
    talepNedenKodId: Number(data.talepNedenKodId) || 0,
    talepNeden: data.talepNeden || "",
    bolumKodId: Number(data.bolumKodId) || 0,
    ...
    islemTipiKodId: Number(data.islemTipiID) || 0,
    girisDepoSiraNo: Number(data.girisDeposuID) || 0,
    cikisDepoSiraNo: Number(data.cikisDeposuID) || 0,
    talepdurumId: Number(data.talepdurumId) || 1,
    talepOncelikId: Number(data.talepOncelikId) || 0,
    ...
    materialMovements: data.fisIcerigi?.map((item) => ({
      ...
      malDurumID: Number(item.malDurumID) || 0,
