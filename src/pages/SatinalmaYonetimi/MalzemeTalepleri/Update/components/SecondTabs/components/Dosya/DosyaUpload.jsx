...
const DosyaUpload = () => {
  ...
  const secilenIsEmriID = watch("secilenTalepID");
  ...
  const fetchDosyaIds = async () => {
    try {
      setLoading(true);
      const response = await AxiosInstance.get(`GetDosyaList?refId=${secilenIsEmriID}&refGrup=CAGRI MERKEZI`);
  ...
  const handleFileUpload = (file) => {
    ...
    AxiosInstance.post(`UploadFile?refid=${secilenIsEmriID}&refgrup=CAGRI MERKEZI`, formData, {
