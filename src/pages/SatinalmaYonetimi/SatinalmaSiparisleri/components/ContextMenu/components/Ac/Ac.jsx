...
import { FolderOpenOutlined } from "@ant-design/icons"; // İkon eklendi

export default function YenidenAc({ selectedRows, refreshTableData, iptalDisabled }) {
  ...
  // Gizleme stili yerine container stili
  ...
  return (
    <FormProvider {...methods}>
      ...
      >
        <div>
          <FolderOpenOutlined style={{ color: "#27ae60", fontSize: "18px", marginTop: "4px" }} />
        </div>
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <span style={{ fontSize: "12px", color: "#8c8c8c", marginTop: "4px", lineHeight: "1.4" }}>
            Kapalı siparişi tekrar açar ve işleme alır.
          </span>
        </div>
      </div>
