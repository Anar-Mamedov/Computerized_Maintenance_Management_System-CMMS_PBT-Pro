...
const LokasyonDagilimTable = () => {
  ...
  const [data, isLoading] = useFetch(
    `GetLokasyonBazindaIsEmriTalebi?startDate=${selectedDate.lokasyon_dagilimi_zaman[0]}&endDate=${selectedDate?.lokasyon_dagilimi_zaman[1]}`,
    [selectedDate?.lokasyon_dagilimi_zaman]
  );
  ...
  return (
    <div style={{ width: "100%", height: "100%", overflow: "auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }} id="lokasyon_dagilimi">
        <h3>
          Lokasyon Bazında İş talepleri / İş Emirleri Dağılımı <br /> ({selectedDate.lokasyon_dagilimi_zaman[0]} /{" "}
          {selectedDate.lokasyon_dagilimi_zaman[1]})
        </h3>
        <Ayarlar
          chart={
            <Table
