...
const ToplamHarcananIsGucu = () => {
  ...
  const [data, isLoading] = useFetch(
    `GetToplamHarcananIsGuc?startDate=${selectedDate?.toplam_harcanan_is_gucu_zaman[0]}&endDate=${selectedDate?.toplam_harcanan_is_gucu_zaman[1]}`,
    [selectedDate.toplam_harcanan_is_gucu_zaman]
  );
