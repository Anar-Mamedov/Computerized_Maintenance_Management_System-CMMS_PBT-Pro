...
export default function BasincMiktar() {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "10px", justifyContent: "space-between", width: "100%" }}>
      {contextHolder}
      <Text style={{ fontSize: "14px" }}>Basınç Miktar:</Text>
      <div style={{ display: "flex", flexWrap: "wrap", gap: "5px" }}>
        <Controller
          name="MakineBasincMiktar"
          control={control}
          render={({ field }) => (
            <Input
              {...field}
          ...
          render={({ field }) => (
            <Select
              ...
              onChange={(value) => {
                ...
                setValue("MakineBasincMiktarBirimID", value);
        ...
        />
        <Controller
          name="MakineBasincMiktarBirimID"
          control={control}
          render={({ field }) => (
            <Input
              {...field}
