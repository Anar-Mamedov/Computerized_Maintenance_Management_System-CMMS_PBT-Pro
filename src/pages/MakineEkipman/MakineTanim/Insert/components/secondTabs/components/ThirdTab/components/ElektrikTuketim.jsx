...
export default function ElektrikTuketim() {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "10px", justifyContent: "space-between", width: "100%" }}>
      {contextHolder}
      <Text style={{ fontSize: "14px" }}>Elektrik Tüketim:</Text>
      <div style={{ display: "flex", flexWrap: "wrap", gap: "5px" }}>
        <Controller
          name="MakineElektrikTuketim"
          control={control}
          render={({ field }) => (
            <Input
              {...field}
        ...
        />
        <Controller
          name="MakineElektrikTuketimBirim"
          control={control}
          render={({ field }) => (
            <Select
              {...field}
              ...
              onChange={(value) => {
                ...
                setValue("MakineElektrikTuketimBirimID", value);
        ...
        />
        <Controller
          name="MakineElektrikTuketimBirimID"
          control={control}
          render={({ field }) => (
            <Input
              {...field}
