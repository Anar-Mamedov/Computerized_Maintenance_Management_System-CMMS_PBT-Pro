...
export default function LinkedWorkOrder({}) {
  ...
  const handleMinusClick = () => {
    ...
    setValue("linked_work_orderID", ""); // Clear the value of the field managed by TreeSelect
  };
  ...
  const rowSelection = {
    ...
    onChange: (selectedKeys, selectedRows) => {
      ...
      if (lastSelectedRow) {
        ...
        setValue("linked_work_orderID", lastSelectedRow.key);
      }
    },
  };
  ...
  useEffect(() => {
    ...
    setValue("linked_work_order", inputValue);
  }, [inputValue, setValue]);
