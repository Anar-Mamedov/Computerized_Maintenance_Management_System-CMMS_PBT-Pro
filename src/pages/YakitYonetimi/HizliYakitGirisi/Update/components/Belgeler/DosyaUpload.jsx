...
const DosyaUpload = ({ selectedRowID }) => {
  ...
  const fetchDosyaIds = async () => {
    try {
      setLoading(true);
      const response = await AxiosInstance.get(`GetDosyaList?refId=${selectedRowID}&refGrup=YAKIT`);
  ...
  const handleFileUpload = (file) => {
    ...
    AxiosInstance.post(`UploadFile?refid=${selectedRowID}&refgrup=YAKIT`, formData, {
