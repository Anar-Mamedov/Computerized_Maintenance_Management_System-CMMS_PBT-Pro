...
const DosyaUpload = () => {
  ...
  const secilenIsEmriID = watch("secilenID");
  ...
  const fetchDosyaIds = async () => {
    try {
      setLoading(true);
      const response = await AxiosInstance.get(`GetDosyaList?refId=${secilenIsEmriID}&refGrup=ATOLYE`);
  ...
  const handleFileUpload = (file) => {
    ...
    AxiosInstance.post(`UploadFile?refid=${secilenIsEmriID}&refgrup=ATOLYE`, formData, {
