...
const MainTable = () => {
  ...
  const ozelAlanlarAtolyeTanimlari = JSON.parse(
    localStorage.getItem("ozelAlanlarAtolyeTanimlari")
  );
  ...
  const initialColumns = [
    {
      ...
      sorter: (a, b) => {
        if (a.ATL_KOD == null || a.ATL_KOD === "") return 1;
        if (b.ATL_KOD == null || b.ATL_KOD === "") return -1;
        if (typeof a.ATL_KOD === "boolean") return a.ATL_KOD - b.ATL_KOD;
        if (!isNaN(a.ATL_KOD) && !isNaN(b.ATL_KOD))
          return a.ATL_KOD - b.ATL_KOD;
        return a.ATL_KOD.toString().localeCompare(b.ATL_KOD.toString());
      },
    },
    {
      title: "Atölye Tanımı",
      ...
      sorter: (a, b) => {
        if (a.ATL_TANIM == null || a.ATL_TANIM === "") return 1;
        if (b.ATL_TANIM == null || b.ATL_TANIM === "") return -1;
        return a.ATL_TANIM.toString().localeCompare(b.ATL_TANIM.toString());
      },
    },
    {
      ...
      sorter: (a, b) => {
        if (a.ATL_GRUP_TANIM == null || a.ATL_GRUP_TANIM === "") return 1;
        if (b.ATL_GRUP_TANIM == null || b.ATL_GRUP_TANIM === "") return -1;
        return a.ATL_GRUP_TANIM.toString().localeCompare(
          b.ATL_GRUP_TANIM.toString()
        );
      },
    },
    {
      ...
      sorter: (a, b) => {
        if (a.ATL_YETKILI == null || a.ATL_YETKILI === "") return 1;
        if (b.ATL_YETKILI == null || b.ATL_YETKILI === "") return -1;
        return a.ATL_YETKILI.toString().localeCompare(b.ATL_YETKILI.toString());
      },
    },
    {
      title: "Telefon",
      ...
      sorter: (a, b) => {
        if (a.ATL_TEL == null || a.ATL_TEL === "") return 1;
        if (b.ATL_TEL == null || b.ATL_TEL === "") return -1;
        return a.ATL_TEL.toString().localeCompare(b.ATL_TEL.toString());
      },
    },
    {
      title: "Açıklama",
      ...
      sorter: (a, b) => {
        if (a.ATL_ACIKLAMA == null || a.ATL_ACIKLAMA === "") return 1;
        if (b.ATL_ACIKLAMA == null || b.ATL_ACIKLAMA === "") return -1;
        return a.ATL_ACIKLAMA.toString().localeCompare(
          b.ATL_ACIKLAMA.toString()
        );
      },
    },
  ...
  useEffect(() => {
    const filtered = data.filter((item) =>
      normalizeString(item.ATL_TANIM).includes(normalizeString(searchTerm))
    );
  ...
  const [columns, setColumns] = useState(() => {
    const savedOrder = localStorage.getItem("columnOrderAtolyeTanimlari");
    const savedVisibility = localStorage.getItem(
      "columnVisibilityAtolyeTanimlari"
    );
    const savedWidths = localStorage.getItem("columnWidthsAtolyeTanimlari");
    ...
    localStorage.setItem("columnOrderAtolyeTanimlari", JSON.stringify(order));
    localStorage.setItem(
      "columnVisibilityAtolyeTanimlari",
      JSON.stringify(visibility)
    );
    localStorage.setItem("columnWidthsAtolyeTanimlari", JSON.stringify(widths));
  ...
  function resetColumns() {
    localStorage.removeItem("columnOrderAtolyeTanimlari");
    localStorage.removeItem("columnVisibilityAtolyeTanimlari");
    localStorage.removeItem("columnWidthsAtolyeTanimlari");
    localStorage.removeItem("ozelAlanlarAtolyeTanimlari");
