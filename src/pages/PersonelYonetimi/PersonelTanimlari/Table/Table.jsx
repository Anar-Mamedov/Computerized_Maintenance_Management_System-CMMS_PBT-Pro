...
const MainTable = () => {
  ...
  const [columns, setColumns] = useState(() => {
    const savedOrder = localStorage.getItem("columnOrderPersonelTanimlari");
    const savedVisibility = localStorage.getItem(
      "columnVisibilityPersonelTanimlari"
    );
    const savedWidths = localStorage.getItem("columnWidthsPersonelTanimlari");
    ...
    localStorage.setItem("columnOrderPersonelTanimlari", JSON.stringify(order));
    localStorage.setItem(
      "columnVisibilityPersonelTanimlari",
      JSON.stringify(visibility)
    );
    localStorage.setItem(
      "columnWidthsPersonelTanimlari",
  ...
  function resetColumns() {
    localStorage.removeItem("columnOrderPersonelTanimlari");
    localStorage.removeItem("columnVisibilityPersonelTanimlari");
    localStorage.removeItem("columnWidthsPersonelTanimlari");
    localStorage.removeItem("ozelAlanlarPersonelTanimlari");
