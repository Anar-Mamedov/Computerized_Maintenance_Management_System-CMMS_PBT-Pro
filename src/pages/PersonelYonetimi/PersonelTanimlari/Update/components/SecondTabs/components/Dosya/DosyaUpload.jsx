...
const DosyaUpload = () => {
  ...
  const secilenIsEmriID = watch("secilenPersonelID");
  ...
  const fetchDosyaIds = async () => {
    try {
      setLoading(true);
      const response = await AxiosInstance.get(`GetDosyaList?refId=${secilenIsEmriID}&refGrup=PERSONEL`);
  ...
  const handleFileUpload = (file) => {
    ...
    AxiosInstance.post(`UploadFile?refid=${secilenIsEmriID}&refgrup=PERSONEL`, formData, {
