...
export default function TaseronTablo({ workshopSelectedId, onSubmit }) {
  ...
  return (
    <div>
      ...
      <Modal width="1200px" title="Taşeron" open={isModalVisible} onOk={handleModalOk} onCancel={handleModalToggle}>
        <Table
          rowSelection={{
            type: "radio",
            selectedRowKeys,
