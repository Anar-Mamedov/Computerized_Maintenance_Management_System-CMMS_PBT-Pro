...
export default function UcuncuTablo({ selectedRowIkinciTablo, isModalVisibleIkinciTablo, onModalClose, onRefresh, secilenIsEmriID }) {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await AxiosInstance.get(`RaporGetPersonelDetay?PersonelID=${selectedRowIkinciTablo.TB_PERSONEL_ID}&RaporIsTipID=${selectedRowIkinciTablo.TB_ISEMRI_TIP_ID}`);
