...
import { ExportOutlined } from "@ant-design/icons"; // İkon değiştirildi
  ...
  return (
    <FormProvider {...methods}>
      <ConfigProvider locale={tr_TR}>
        ...
        >
          <div>
            {/* Görseldeki gibi koyu gri ikon */}
            <ExportOutlined style={{ color: '#595959', fontSize: '18px', marginTop: '4px' }} />
          </div>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <span style={{ fontSize: '12px', color: '#8c8c8c', marginTop: '4px', lineHeight: '1.4' }}>
              Talebi satınalma siparişine dönüştür.
            </span>
          </div>
        </div>
