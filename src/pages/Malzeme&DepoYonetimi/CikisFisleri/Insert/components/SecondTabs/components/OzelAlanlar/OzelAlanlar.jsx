...
function OzelAlanlar(props) {
  ...
  const nameOfField = async () => {
    try {
      const response = await AxiosInstance.get(`OzelAlan?form=ÇIKIŞ FİŞİ`);
    ...
    <div style={{ display: "flex", gap: "10px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", width: "100%", maxWidth: "450px", gap: "10px", rowGap: "0px" }}>
          ...
          >
            <KodIDSelectbox name1="ozelAlan11" isRequired={false} kodID="13031" />
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", width: "100%", maxWidth: "450px", gap: "10px", rowGap: "0px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", maxWidth: "300px", minWidth: "300px", gap: "10px", width: "100%" }}>
            <KodIDSelectbox name1="ozelAlan12" isRequired={false} kodID="13032" />
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", width: "100%", maxWidth: "450px", gap: "10px", rowGap: "0px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", maxWidth: "300px", minWidth: "300px", gap: "10px", width: "100%" }}>
            <KodIDSelectbox name1="ozelAlan13" isRequired={false} kodID="13033" />
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", width: "100%", maxWidth: "450px", gap: "10px", rowGap: "0px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", maxWidth: "300px", minWidth: "300px", gap: "10px", width: "100%" }}>
            <KodIDSelectbox name1="ozelAlan14" isRequired={false} kodID="13034" />
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", width: "100%", maxWidth: "450px", gap: "10px", rowGap: "0px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", maxWidth: "300px", minWidth: "300px", gap: "10px", width: "100%" }}>
            <KodIDSelectbox name1="ozelAlan15" isRequired={false} kodID="13035" />
          </div>
        </div>
