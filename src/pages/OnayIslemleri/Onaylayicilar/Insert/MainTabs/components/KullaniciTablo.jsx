...
export default function KullaniciTablo({ workshopSelectedId, onSubmit }) {
  ...
  const fetch = useCallback(() => {
    setLoading(true);
    AxiosInstance.get(`GetTBKullaniciList`)
      .then((response) => {
  ...
  return (
    <div>
      ...
      <Modal width={1200} centered title="Kullanıcı Listesi" open={isModalVisible} onOk={handleModalOk} onCancel={handleModalToggle}>
