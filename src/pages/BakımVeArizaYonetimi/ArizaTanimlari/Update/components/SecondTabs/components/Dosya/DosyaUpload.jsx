...
const DosyaUpload = () => {
  ...
  const secilenIsEmriID = watch("secilenBakimID");
  ...
  const fetchDosyaIds = async () => {
    try {
      setLoading(true);
      const response = await AxiosInstance.get(`GetDosyaList?refId=${secilenIsEmriID}&refGrup=ARIZA`);
  ...
  const handleFileUpload = (file) => {
    ...
    AxiosInstance.post(`UploadFile?refid=${secilenIsEmriID}&refgrup=ARIZA`, formData, {
