...
const MainTable = () => {
  ...
  function resetColumns() {
    localStorage.removeItem("columnOrderBakimTanimlari");
    localStorage.removeItem("columnVisibilityBakimTanimlari");
    localStorage.removeItem("columnWidthsBakimTanimlari");
    localStorage.removeItem("ozelAlanlarBakimTanimlari");
