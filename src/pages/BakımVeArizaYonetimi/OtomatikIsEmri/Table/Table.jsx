...
import { Input, Table, Spin, Button, Modal, Checkbox, Tabs } from "antd";
import { CheckOutlined, CloseOutlined, SearchOutlined, MenuOutlined } from "@ant-design/icons";
import AxiosInstance from "../../../../api/http";
import TarihBazli from "./TarihBazli";
import SayacBazli from "./SayacBazli";
...
const items = [
    {
        key: '1',
        label: 'Tarih Bazlı Periyodik Bakım',
        children: <TarihBazli />,
    },
    {
        key: '2',
        label: 'Sayaç Bazlı Periyodik Bakım',
        children: <SayacBazli />,
    }
];
