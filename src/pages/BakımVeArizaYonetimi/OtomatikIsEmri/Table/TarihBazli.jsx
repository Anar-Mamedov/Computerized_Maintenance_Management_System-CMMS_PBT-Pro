...
import TarihBazliCustomFilter from './components/custom-filter/TarihBazliCustomFilter'
...
const TarihBazli = () => {
    ...
    return (
        ...
        <div style={{
            ...
            {/* filter */}
            <TarihBazliCustomFilter onSubmit={(newFilters) => setFilters((state) => ({ ...state, customfilters: newFilters }))} />
