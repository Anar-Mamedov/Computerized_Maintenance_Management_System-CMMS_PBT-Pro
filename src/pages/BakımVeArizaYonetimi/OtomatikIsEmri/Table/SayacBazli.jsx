...
import SayacBazliCustomFilter from './components/custom-filter/TarihBazliCustomFilter'
...
const TarihBazli = () => {
    ...
    return (
        ...
        <div style={{
            ...
            {/* filter */}
            <SayacBazliCustomFilter onSubmit={(newFilters) => setFilters((state) => ({ ...state, customfilters: newFilters }))} />
