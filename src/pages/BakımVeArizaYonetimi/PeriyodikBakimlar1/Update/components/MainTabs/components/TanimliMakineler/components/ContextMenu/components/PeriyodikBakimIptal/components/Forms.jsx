  ...
  return (
    <div style={buttonStyle}>
      ...
      <div style={{ marginBottom: "10px", display: "flex" }}>
        ...
        <Text>{new Intl.DateTimeFormat(navigator.language).format(new Date(selectedRows[0].PBM_HEDEF_TARIH))}</Text>
      </div>
      {/* <div
        style={{
          display: "flex",
      ...
      >
        <Text style={{ fontSize: "14px", fontWeight: "600" }}>İptal Nedeni:</Text>
        <div
          style={{
            display: "flex",
            flexWrap: "wrap",
