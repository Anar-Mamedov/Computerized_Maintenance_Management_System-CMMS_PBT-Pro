    ...
    <div style={{ marginTop: "10px" }}>
      ...
      >
        ...
        >
          ...
          >
            <Controller name="sayac" control={control} render={({ field }) => <InputNumber {...field} disabled min={0} style={{ width: "180px" }} />} />
          </div>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            <Controller name="sonUygulamaSayac" control={control} render={({ field }) => <InputNumber {...field} disabled min={0} style={{ width: "180px" }} />} />
          </div>
        </div>
        <div
          style={{
