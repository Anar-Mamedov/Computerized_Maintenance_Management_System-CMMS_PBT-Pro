    ...
    <div>
      ...
      <div style={{ marginTop: "10px" }}>
        ...
        >
          ...
          >
            <Text style={{ fontSize: "14px", width: "152px" }}>
              Son Uygulama Tarihi
            </Text>
            <div
              style={{
            ...
            >
              <Controller
                ...
                render={({ field, fieldState: { error } }) => (
                  <DatePicker
                    {...field}
                    status={errors.hedefTarih ? "error" : ""}
                    disabled
                    style={{ width: "180px" }}
                    format={localeDateFormat}
                    placeholder="Tarih seçiniz"
        ...
        >
          ...
          >
            ...
            >
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <InputNumber {...field} min={0} style={{ width: "180px" }} />
                )}
              />
            </div>
          </div>
          ...
          >
            ...
            <div style={{ display: "flex", gap: "5px", alignItems: "center" }}>
              ...
              />
              <Controller
                name="hatırlatmaDinamikOnce"
                control={control}
                render={({ field }) => (
                  <Input {...field} disabled style={{ width: "105px" }} />
                )}
              />
              <Text> önce</Text>
            </div>
