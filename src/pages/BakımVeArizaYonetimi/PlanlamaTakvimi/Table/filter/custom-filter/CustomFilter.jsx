...
export default function CustomFilter({ onSubmit1, isEmpty }) {
  ...
  const onSubmit = (data) => {
    ...
    const filterData = {
      ...
      lokasyon: lokasyonID ? lokasyonID : -1,
      makine: makineID ? makineID : -1,
      makineTipi: makineTipiID ? makineTipiID : -1,
      bakimGrubu: bakimGrubuID ? bakimGrubuID : -1,
      bakimTipi: bakimTipiID ? bakimTipiID : -1,
      atolye: atolyeID ? atolyeID : -1,
      bakim: bakimID ? bakimID : -1,
    };
