...
function ComponentSingleCard() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setData(response.EnYavasMudahaleSuresi);
    } catch (error) {
  ...
  return (
    <>
      <div style={{ width: "100%", height: "100%" }}>
        {renderCard(data?.EnYavasMudahaleSuresi, t("enYavasMudahaleSuresi"), "linear-gradient(to right, #ff4e50, #f9d423)", "dk.", isLoading, handleCardClick)}
      </div>
