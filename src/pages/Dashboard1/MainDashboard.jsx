...
function MainDashboard() {
  ...
  useEffect(() => {
    ...
    const defaultItems = [
      ...
      { id: "widget12", x: 0, y: 1, width: 12, height: 3, minW: 4, minH: 3 },
      { id: "widget5", x: 0, y: 4, width: 4, height: 3, minW: 3, minH: 2 },
      { id: "widget10", x: 4, y: 4, width: 4, height: 3, minW: 4, minH: 3 },
      { id: "widget13", x: 0, y: 7, width: 4, height: 3, minW: 4, minH: 3 },
      { id: "widget14", x: 4, y: 7, width: 4, height: 3, minW: 4, minH: 3 },
      { id: "widget11", x: 8, y: 4, width: 4, height: 3, minW: 4, minH: 3 },
