...
function IsEmriZamanDagilimi(props = {}) {
  ...
  useEffect(() => {
    ...
    watch("baslamaTarihiIsEmriZaman"),
    watch("bitisTarihiIsEmriZaman"),
    watch("aySecimiIsEmriZaman"),
    watch("yilSecimiIsEmriZaman"),
  ]);
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await AxiosInstance.get(
        `GetIsEmirleriByTarih?startDate=${baslamaTarihi}&endDate=${bitisTarihi}`
      );
