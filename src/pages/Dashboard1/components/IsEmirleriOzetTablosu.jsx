  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => {
        ...
        const average =
          record.IS_EMRI_SAYISI !== 0
            ? record.TOPLAM_CALISMA_SURESI / record.IS_EMRI_SAYISI
            : 0;
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await AxiosInstance.get(
        `GetIsEmriOzetTable?startDate=${baslamaTarihi}&endDate=${bitisTarihi}`
      );
