...
const MainTable = () => {
  ...
  const ozelAlanlarVardiyaTanimlari = JSON.parse(
    localStorage.getItem("ozelAlanlarVardiyaTanimlari")
  );
  ...
  const [columns, setColumns] = useState(() => {
    const savedOrder = localStorage.getItem("columnOrderVardiyaTanimlari");
    const savedVisibility = localStorage.getItem(
      "columnVisibilityVardiyaTanimlari"
    );
    const savedWidths = localStorage.getItem("columnWidthsVardiyaTanimlari");
    ...
    localStorage.setItem("columnOrderVardiyaTanimlari", JSON.stringify(order));
    localStorage.setItem(
      "columnVisibilityVardiyaTanimlari",
      JSON.stringify(visibility)
    );
    localStorage.setItem(
      "columnWidthsVardiyaTanimlari",
  ...
  function resetColumns() {
    localStorage.removeItem("columnOrderVardiyaTanimlari");
    localStorage.removeItem("columnVisibilityVardiyaTanimlari");
    localStorage.removeItem("columnWidthsVardiyaTanimlari");
    localStorage.removeItem("ozelAlanlarVardiyaTanimlari");
