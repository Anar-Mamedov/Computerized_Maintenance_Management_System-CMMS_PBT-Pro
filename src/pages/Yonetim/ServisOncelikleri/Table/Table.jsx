...
const MainTable = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        localStorage.setItem(
          "ozelAlanlarServisOncelikleriSeviyeleri",
  ...
  const ozelAlanlarServisOncelikleriSeviyeleri = JSON.parse(
    localStorage.getItem("ozelAlanlarServisOncelikleriSeviyeleri")
  );
  ...
  const initialColumns = [
    {
      ...
      sorter: (a, b) => {
        if (a.Kod === null) return -1;
        if (b.Kod === null) return 1;
    ...
    },
    {
      ...
      visible: true,
      sorter: (a, b) => {
        if (a.Tanim == null || a.Tanim === "") return 1;
        if (b.Tanim == null || b.Tanim === "") return -1;
        return a.Tanim.toString().localeCompare(
          b.Tanim.toString()
        );
      },
    },
    ...
    {
      title: "Çözüm Süresi",
      dataIndex: "CozumSuresiText",
      key: "CozumSuresiText",
      width: 200,
      ellipsis: true,
      visible: true,
      sorter: (a, b) => {
        if (a.CozumSuresiText == null || a.CozumSuresiText === "") return 1;
        if (b.CozumSuresiText == null || b.CozumSuresiText === "") return -1;
        return a.CozumSuresiText.toString().localeCompare(b.CozumSuresiText.toString());
      },
    },
    {
      title: "Gecikme",
      dataIndex: "GecikmeDakika",
      key: "GecikmeDakika",
      width: 200,
      ellipsis: true,
      visible: true,
      sorter: (a, b) => {
        if (a.GecikmeDakika == null || a.GecikmeDakika === "") return 1;
        if (b.GecikmeDakika == null || b.GecikmeDakika === "") return -1;
        return a.GecikmeDakika.toString().localeCompare(b.GecikmeDakika.toString());
      },
    },
    {
      title: "Kritik",
      dataIndex: "KritikDakika",
      key: "KritikDakika",
      width: 200,
      ellipsis: true,
      visible: true,
      sorter: (a, b) => {
        if (a.KritikDakika == null || a.KritikDakika === "") return 1;
        if (b.KritikDakika == null || b.KritikDakika === "") return -1;
        return a.KritikDakika.toString().localeCompare(b.KritikDakika.toString());
      },
    },
  ...
  const fetchEquipmentData = useCallback(async (word = "") => {
    try {
      ...
      const response = await AxiosInstance.get(`GetServisOncelikList?kelime=${word}`);
  ...
  const [columns, setColumns] = useState(() => {
    const savedOrder = localStorage.getItem("columnOrderServisOncelikleriSeviyeleri");
    const savedVisibility = localStorage.getItem(
      "columnVisibilityServisOncelikleriSeviyeleri"
    );
    const savedWidths = localStorage.getItem("columnWidthsServisOncelikleriSeviyeleri");
    ...
    localStorage.setItem("columnOrderServisOncelikleriSeviyeleri", JSON.stringify(order));
    localStorage.setItem(
      "columnVisibilityServisOncelikleriSeviyeleri",
      JSON.stringify(visibility)
    );
    localStorage.setItem(
      "columnWidthsServisOncelikleriSeviyeleri",
  ...
  useEffect(() => {
    localStorage.setItem(
      "columnOrderServisOncelikleriSeviyeleri",
  ...
  function resetColumns() {
    localStorage.removeItem("columnOrderServisOncelikleriSeviyeleri");
    localStorage.removeItem("columnVisibilityServisOncelikleriSeviyeleri");
    localStorage.removeItem("columnWidthsServisOncelikleriSeviyeleri");
    localStorage.removeItem("ozelAlanlarServisOncelikleriSeviyeleri");
