  ...
  const items = [
    ...
    }, */
    {
      ...
      label: (
        <div style={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
          <DatabaseOutlined />
          <div style={{ paddingTop: "2px" }}>{t("genelParametreler")}</div>
        </div>
      ),
    ...
    },
    {
      ...
      label: (
        <div style={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
          <DatabaseOutlined />
          <div style={{ paddingTop: "2px" }}>{t("malzemeVeDepoYonteimi")}</div>
        </div>
      ),
    ...
    /* {
      ...
      children: activeKey === "6" && <OtomatikKodlar />,
    },
    {
      key: "7",
      label: (
      ...
      children: activeKey === "7" && <YakitIslemleri />,
    }, */
  ];
