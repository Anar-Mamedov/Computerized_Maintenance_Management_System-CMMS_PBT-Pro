...
function MainDashboard() {
  ...
  const [kirilim4, setKirilim4] = useState(1); 
  ...
  const { watch } = methods;
  const selectedDashboard = "ArizaAnaliz";
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const response = await AxiosInstance.post("GetArizaAnalizDashboard", payload);
  ...
  const fetchListData = async (targetTable = "all") => {
    ...
    try {
      ...
      const response = await AxiosInstance.post(
        `GetArizaAnalizListeler?page=${activePage}&pageSize=${activePageSize}`, 
        payload
      );
      ...
      items.forEach((item) => {
        ...
        switch (item.id) {
          case "widget1":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component1 apiData={dashboardData ? dashboardData.ToplamArizaSayisi : null} loading={loading} />
          ...
          case "widget2":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component2 apiData={dashboardData ? dashboardData.ArizaYogunlugu : null} loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget3":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component3 apiData={dashboardData ? dashboardData.OrtalamaCozumSuresiSaat : null} loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget4":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component4 apiData={dashboardData ? dashboardData.OrtalamaArizaMaliyeti : null} loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget7":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component5 apiData={dashboardData ? dashboardData.TekrarlayanArizaOrani : null} loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget5":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component7 tipDagilimi={dashboardData ? dashboardData.NedenDagilimi : null} durumDagilimi={dashboardData ? dashboardData.TipDagilimi : null} loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget6":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component8 ekipmanDagilimi={dashboardData ? dashboardData.EkipmanDagilimi : null} loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget11":
          ...
          case "widget23":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component9 
                  apiData={dashboardData ? dashboardData.EnCokArizalananEkipman : null}
                  arizaSayi={dashboardData ? dashboardData.EnCokArizalananEkipmanSayi : null} 
                  loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget24":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component10 
                  apiData={dashboardData ? dashboardData.EnYuksekMaliyetliArizaEkipman : null}
                  arizaSayi={dashboardData ? dashboardData.EnYuksekMaliyetliArizaTutar : null}
                  loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget25":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component11 
                  apiData={dashboardData ? dashboardData.ArizaBasinaOrtalamaMaliyet : null}
                  arizaSayi={dashboardData ? dashboardData.EnUzunSurenArizaEkipman : null}
                  loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget26":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component12 
                  apiData={dashboardData ? dashboardData.EnUzunSurenArizaEkipman : null}
                  arizaSayi={dashboardData ? dashboardData.EnUzunSurenArizaSaat : null}
                  loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget27":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component13 
                  apiData={dashboardData ? dashboardData.ToplamArizaSuresiSaat : null} 
          ...
          case "widget28":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component14 
                  apiData={dashboardData ? dashboardData.EnFazlaTekrarlayanArizaNeden : null} 
                  arizaSayi={dashboardData ? dashboardData.EnFazlaTekrarlayanArizaSayi : null} // Kanka ad buraya eklendi
                  loading={loading} 
                />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
          ...
          case "widget20":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <ArizaliMakineler listeData={listData ? listData.Liste2 : null} loading={loading} breakdownType={breakdownType}
                  onBreakdownTypeChange={(val) => setBreakdownType(val)} page={page2} pageSize={pageSize2} totalItems={listData ? listData.Liste2TotalCount : 0} onPageChange={(p, ps) => { setPage2(p); setPageSize2(ps); }} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget21":
          ...
          case "widget22":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <AylikMaliyetler listeData={listData ? listData.Liste4 : null} 
                  loading={loading} 
                  kirilim4={kirilim4} 
                  onKirilim4Change={(val) => setKirilim4(val)} 
                  page={page4} 
                  pageSize={pageSize4} 
                  totalItems={listData ? listData.Liste4TotalCount : 0} 
                  onPageChange={(p, ps) => { setPage4(p); setPageSize4(ps); }} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          default:
  ...
  const handleReset = () => {
    ...
    localStorage.removeItem("reorganizeArizaAnaliz");
