  ...
  const renderChart = () => (
    <ResponsiveContainer width="100%" height="100%">
      <ComposedChart data={data} margin={{ top: 20, right: 10, left: -20, bottom: 5 }}>
        ...
        <Bar dataKey="AcilanIsEmri" name="Açılan İş Emri" fill="#1890ff" barSize={50} radius={[6, 6, 0, 0]} />
        <Line type="monotone" dataKey="KapananIsEmri" name="Kapanan İş Emri" stroke="#52c41a" strokeWidth={3} dot={{ r: 5, stroke: "#52c41a", strokeWidth: 2, fill: "#fff" }} activeDot={{ r: 7 }} />
      </ComposedChart>
    </ResponsiveContainer>
  );
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            <Text style={{ fontWeight: "600", fontSize: "16px" }}>
              İş Emirleri Trend Grafiği ({isCustomYearSelected ? selectedYear : "Ana Filtre"})
            </Text>
          </div>
          <Text type="secondary" style={{ fontSize: "12px" }}>Sütun açılan, çizgi kapanan iş emirlerini gösterir</Text>
        </div>
