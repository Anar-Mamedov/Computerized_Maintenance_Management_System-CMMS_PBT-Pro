...
const widgetTitles = {
  widget1: "Toplam Talep Sayısı",
  widget2: "Ortalama Müdahele Süresi",
  widget3: "En Hızlı Müdahele Süresi",
...
const defaultItems = [
  ...
  { id: "widget7", x: 8, y: 0, width: 2, height: 1, minW: 2, minH: 1 },
  { id: "widget8", x: 10, y: 0, width: 2, height: 1, minW: 2, minH: 1 },
  ...
  { id: "widget11", x: 0, y: 10, width: 12, height: 5, minW: 3, minH: 2 },
];
...
function MainDashboard() {
  ...
  const selectedDashboard = "MudaheleSuresiAnalizi";
  ...
  const handleReset = () => {
    ...
    localStorage.removeItem("reorganizeMudaheleSuresiAnalizi");
