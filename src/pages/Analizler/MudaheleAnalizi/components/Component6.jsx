...
function ComponentSingleCard() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setData(response.ToplamCalismaSuresi);
    } catch (error) {
            ...
            <div style={{ display: "flex", alignItems: "center", width: "100%" }}>
              <div
                style={{
                  ...
                  whiteSpace: "nowrap",
                  // flex: 1,
                  minWidth: 0, // This is important for text-overflow to work
                  color: "white",
                }}
              >
                <Text style={{ fontWeight: "500", fontSize: "35px", color: "white" }} title={value !== null && value !== undefined ? value.toLocaleString("tr-TR") : ""}>
                  {value !== null &&
                    value !== undefined &&
  ...
  return (
    <div style={{ width: "100%", height: "100%" }}>
      {renderCard(
        ...
        t("toplamCalismaSuresi"), // Kart üzerindeki başlık/label
        "linear-gradient(to right, #f7971e, #ffd200)", // Arka plan
        "dk.", // Birim
