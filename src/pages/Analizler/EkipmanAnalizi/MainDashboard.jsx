...
function MainDashboard() {
  ...
  const { watch } = methods;
  const selectedDashboard = "EkipmanAnaliz";
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const response = await AxiosInstance.post("GetEkipmanAnalizDashboard", payload);
  ...
  const fetchListData = async (targetTable = "all") => {
    ...
    try {
      ...
      const response = await AxiosInstance.post(
        `GetEkipmanAnalizListeler?page=${activePage}&pageSize=${activePageSize}`, 
        payload
      );
      ...
      items.forEach((item) => {
        ...
        switch (item.id) {
          case "widget1":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component1 apiData={dashboardData ? dashboardData.ToplamEkipmanSayisi : null} loading={loading} />
          ...
          case "widget2":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component2 apiData={dashboardData ? dashboardData.ArizaMaliyeti : null} loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget3":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component3 apiData={dashboardData ? dashboardData.PlanliBakimOrani : null} loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget4":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component4 apiData={dashboardData ? dashboardData.EkipmanKullanimOrani : null} loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget7":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component5 apiData={dashboardData ? dashboardData.EnCokArizaYapanMakine : null} loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget5":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component7 yasDagilimi={dashboardData ? dashboardData.YasDagilimi : null} loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget6":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <Component8 yedekParcaTuketimi={dashboardData ? dashboardData.YedekParcaTuketimi : null} loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget11":
          ...
          case "widget18":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <LokasyonBazindaYakitTuketimleri lokasyonHaritasi={dashboardData ? dashboardData.LokasyonHaritasi : null} loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget19":
            root.render(
              <FormProvider {...methods}><I18nextProvider i18n={i18n}><ConfigProvider locale={trTR}><AppProvider><BrowserRouter>
                <AylikYakitTuketimleri maliyetDagilimi={dashboardData ? dashboardData.MaliyetDagilimi : null} loading={loading} />
              </BrowserRouter></AppProvider></ConfigProvider></I18nextProvider></FormProvider>
            );
            break;
          case "widget20":
  ...
  const handleReset = () => {
    ...
    localStorage.removeItem("reorganizeEkipmanAnaliz");
