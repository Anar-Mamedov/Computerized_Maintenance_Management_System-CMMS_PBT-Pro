...
import CreateDrawer from "../../../../YardimMasasi/IsTalepleri/Insert/CreateDrawer";
import EditDrawer from "../../../../YardimMasasi/IsTalepleri/Update/EditDrawer";
import Filters from "../../../../YardimMasasi/IsTalepleri/Table/filter/Filters";
...
const MainTable = ({ selectedBarData, mudaheleBody }) => {
  ...
  console.log(selectedBarData?.MudaheleSuresiAraligi);
  console.log(mudaheleBody);
  ...
  const fetchEquipmentData = async (body, page, size) => {
    ...
    try {
      ...
      const response = await AxiosInstance.post(
        `GetMudahaleFullList?parametre=${keyword}&MAralik=${selectedBarData?.MudaheleSuresiAraligi}&pagingDeger=${currentPage}&pageSize=${size}`,
        updatedFilters
      );
      if (response) {
