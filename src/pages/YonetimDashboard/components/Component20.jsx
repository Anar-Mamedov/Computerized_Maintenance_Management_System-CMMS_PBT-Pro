...
import { CarOutlined } from "@ant-design/icons"; // Makine ikonu
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          >
            Son 24 saat hareket/çalışma kaydı var
          </Text>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
            <div style={{
                ...
                <CarOutlined style={{ color: "#fff", fontSize: "28px" }} />
            </div>
        </div>
      </div>
