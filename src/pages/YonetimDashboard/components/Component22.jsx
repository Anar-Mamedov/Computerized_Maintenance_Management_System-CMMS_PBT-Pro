...
import { FormOutlined } from "@ant-design/icons"; // İş Emri İkonu
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
            <div style={{
                ...
                <FormOutlined style={{ color: "#fff", fontSize: "28px" }} />
            </div>
        </div>
      </div>
      ...
      <Modal 
        width={1400} 
        centered 
        title="Açık İş Emirleri Detayları" 
        open={isModalVisible} 
        onOk={handleOk} 
