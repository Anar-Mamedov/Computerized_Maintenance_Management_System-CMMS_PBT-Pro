...
const DosyaUpload = ({ selectedRowID, refGroup }) => {
  ...
  const fetchDosyaIds = async () => {
    try {
      setLoading(true);
      const response = await AxiosInstance.get(`GetDosyaList?refId=${selectedRowID}&refGrup=${refGroup}`);
  ...
  const handleFileUpload = (file) => {
    ...
    AxiosInstance.post(`UploadFile?refid=${selectedRowID}&refgrup=${refGroup}`, formData, {
