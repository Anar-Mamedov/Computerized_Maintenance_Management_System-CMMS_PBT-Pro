...
export default function FifoTablo({ workshopSelectedId, onSubmit, selectedRowID, materialCode: materialCodeProp }) {
  ...
  const modalTitle = materialCode ? `Fifo Fiyat Listesi - ${materialCode}` : "Fifo Fiyat Listesi";
