...
export default function StokMıktarTablo({ workshopSelectedId, onSubmit, selectedRowID, materialCode: materialCodeProp }) {
  ...
  const modalTitle = materialCode ? `Malzeme Depo Dağılımı - ${materialCode}` : "Malzeme Depo Dağılımı";
