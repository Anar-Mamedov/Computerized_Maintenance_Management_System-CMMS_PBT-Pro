...
import SearchComponent from "./pages/Headers/components/SearchComponent.jsx";
...
const BaseLayout = () => {
  ...
  const [selectedKey, setSelectedKey] = useState(""); // Seçilen menü öğesi için state
  ...
  useEffect(() => {
    // Uygulama yüklendiğinde mevcut path'i setSelectedKey ile belirleyin
